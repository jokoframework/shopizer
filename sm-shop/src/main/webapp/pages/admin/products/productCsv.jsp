	...
	<div class="tab-content">
		...
		<div class="tab-pane active" id="catalogue-section">
			...
			<div class="sm-ui-component">
				<h3>
					<s:message code="label.product.upload.csv.file"
						text="Upload csv product file" />
				</h3>
				<br />
				<br />

				<c:url var="productSave" value="/admin/products/saveCsv.html" />
				<form:form method="POST" enctype="multipart/form-data"
					modelAttribute="product" action="${productSave}">
					...
					<div class="control-group">
						<label><s:message code="label.file.csv" text="CSV File" />&nbsp;</label>
