...
<div class="cartbox" id="cart-box">
	<div class="box-content clearfix">
		...
		<div id="shoppingcart">
			...
			<button class="button btn btn-large checkoutButton" style="width: 100%" type="button" onclick="viewShoppingCartPage();"><s:message code="label.checkout" text="Checkout"/></button>
		</div>
	</div>
</div>